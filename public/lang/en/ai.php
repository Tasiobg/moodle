...
$string['actiondetailsummary'] = 'Action summary';
...
$string['backtousagereport'] = 'Back to AI usage report';
...
$string['detailcolumn'] = 'Detail';
$string['detailcolumn_help'] = 'View the full detail of this AI action, including the full prompt sent to the provider and its full generated response.';
$string['detailpagetitle'] = 'AI action detail';
...
$string['error:401:upstreamless'] = 'Unable to connect to the AI service. Try again later.';
$string['error:404'] = 'Not found';
$string['error:404:upstreamless'] = 'The AI service is temporarily unavailable. Try again later.';
$string['error:429'] = 'Too many requests';
$string['error:429:internalsitewide'] = 'The AI service has reached the maximum number of site-wide requests per hour. Try again later.';
$string['error:429:internaluser'] = 'You have reached the maximum number of AI requests you can make in an hour. Try again later.';
$string['error:429:upstreamless'] = 'This AI service has reached its request limit. Try again later.';
...
$string['generatedimage'] = 'Generated image';
...
$string['model'] = 'Model';
$string['noimageavailable'] = 'No image is available for this action.';
$string['nopermissiontoviewdetail'] = 'You do not have permission to view the detail of this AI action.';
...
$string['privacy:metadata:ai_action_register:actionid'] = 'The ID of the action request.';
  ...
  $string['privacy:metadata:ai_action_register:completiontokens'] = 'The completion tokens used for the request.';
  $string['privacy:metadata:ai_action_register:courseid'] = 'The ID of the course the action\'s context resolves to.';
$string['privacy:metadata:ai_action_register:model'] = 'The model used to generate the response.';
$string['privacy:metadata:ai_action_register:prompttokens'] = 'The prompt tokens used for the request.';
...
$string['revisedprompt'] = 'Provider-revised prompt';
