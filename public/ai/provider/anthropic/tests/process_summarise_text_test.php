...
/**
 * Tests for the summarise_text processor of the Anthropic Claude provider.
 *
 * @package    aiprovider_anthropic
 * @copyright  2026 Matt Porritt <matt.porritt@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
#[CoversClass(\aiprovider_anthropic\process_summarise_text::class)]
...
final class process_summarise_text_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $this->action = new \core_ai\aiactions\summarise_text(
            contextid: 1,
            userid: 1,
            prompttext: 'Long text to summarise.',
        );
    }

    /**
     * Test query_ai_api for a successful summarise_text call.
     */
    ...
    /**
     * Test prepare_response success for summarise_text.
     */
    public function test_prepare_response_success(): void {
        ...
        $response = [
            'success' => true,
            'id' => 'msg_abc123',
            'generatedcontent' => 'A brief summary of the text.',
        ...
        $this->assertEquals(\core_ai\aiactions\summarise_text::class, $result->get_actionname());
    }
}
